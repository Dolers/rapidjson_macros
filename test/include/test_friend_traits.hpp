...
class friend_all_getter_setter_trait_class
{
public:
...
class friend_n_getter_setter_trait_class
{
public:
    const bool& get_bool() const { return my_bool; }
...
class friend_tpl_all_getter_setter_trait_class
{
public:
...
template <typename T1, typename T2, typename T3>
class friend_tpl_n_getter_setter_trait_class
{
public:
    const T1& get_type1() const { return my_type1; }
    const T2& get_type2() const { return my_type2; }
