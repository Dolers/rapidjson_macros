...
class all_ctor_getter_name_trait_class
{
public:
    all_ctor_getter_name_trait_class(
        bool b,
        int32_t i32,
        int64_t i64,
        std::string str,
...
class n_ctor_getter_name_trait_class
{
public:
    n_ctor_getter_name_trait_class(
        bool b,
        uint32_t u32,
        uint64_t u64,
        const char* str,
...
class tpl_all_ctor_getter_name_trait_class
{
public:
    tpl_all_ctor_getter_name_trait_class(T1 type1, T2 type2, T3 type3)
...
template <typename T1, typename T2, typename T3>
class tpl_n_ctor_getter_name_trait_class
{
public:
    tpl_n_ctor_getter_name_trait_class(T1 type1, T2 type2, T3 type3)
        : my_type1(type1), my_type2(type2), my_type3(type3)
    {
    }
    const T1& get_type1() const { return my_type1; }
