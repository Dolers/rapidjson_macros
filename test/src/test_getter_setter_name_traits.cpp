...
#include <test_getter_setter_name_traits.hpp>

#include <sstream>
#include <algorithm>

RAPIDJSON_ALL_GETTER_SETTER_NAME_TRAITS(all_getter_setter_name_trait_class,
                                        (get_bool, set_bool, "b"),
                                        (get_int32, set_int32, "i32"),
                                        (get_int64, set_int64, "i64"),
                                        (get_string, set_string, "str"),
                                        (get_vector, set_vector, "v"),
                                        (get_array, set_array, "a"),
                                        (get_map, set_map, "m"),
                                        (get_dict, set_dict, "d"),
                                        (get_set, set_set, "set"));
RAPIDJSON_N_GETTER_SETTER_NAME_TRAITS(n_getter_setter_name_trait_class, 4,
                                      (get_bool, set_bool, "b"),
                                      (get_uint32, set_uint32, "u32"),
                                      (get_uint64, set_uint64, "u64"),
                                      (get_string, set_string, "str"),
                                      (get_list, set_list, "l"),
                                      (get_array, set_array, "a"),
                                      (get_map, set_map, "m"),
                                      (get_dict, set_dict, "d"),
                                      (get_set, set_set, "set"));
RAPIDJSON_TPL_ALL_GETTER_SETTER_NAME_TRAITS(3, tpl_all_getter_setter_name_trait_class, (get_type1, set_type1, "t1"), (get_type2, set_type2, "t2"), (get_type3, set_type3, "t3"));
RAPIDJSON_TPL_N_GETTER_SETTER_NAME_TRAITS(3, tpl_n_getter_setter_name_trait_class, 2, (get_type1, set_type1, "t1"), (get_type2, set_type2, "t2"), (get_type3, set_type3, "t3"));

using namespace rapidjson_macros;

TEMPLATE_TEST_CASE_SIG("ALL_GETTER_SETTER_NAME_TRAITS", "[ALL][GETTER_SETTER_NAME]", (typename Enc), rapidjson::UTF8<>, rapidjson::UTF16<>, rapidjson::UTF16LE<>, rapidjson::UTF16BE<>, rapidjson::UTF32<char32_t>, rapidjson::UTF32<unsigned>)
{
    SECTION("Can use as()", "[as]")
    {
        SECTION("to detect invalids")
        {
            REQUIRE_THROWS(as<all_getter_setter_name_trait_class, Enc>(STR_LITERAL(R"()")));
            REQUIRE_THROWS(as<all_getter_setter_name_trait_class, Enc>(STR_LITERAL(R"("unknown")")));
            REQUIRE_THROWS(as<all_getter_setter_name_trait_class, Enc>(
                STR_LITERAL(R"(
                {
                    "b": true,
                    "i32": 1234,
        ...
        auto val = as<all_getter_setter_name_trait_class, Enc>(
            STR_LITERAL(R"(
                {
                    "b": true,
                    "i32": -1234,
    ...
    SECTION("Can use to_json()", "[to_json]")
    {
        ...
        all_getter_setter_name_trait_class val;
        val.set_bool(true);
        val.set_int32(-1234);
        val.set_int64(5678);
        ...
        auto json = to_json<all_getter_setter_name_trait_class, Enc>(val, doc.GetAllocator());
    ...
    SECTION("Can use to_stream(std::ostream)", "[to_stream]")
    {
        ...
        to_stream<all_getter_setter_name_trait_class, Enc>(ss, val);
        auto value = ss.str();
...
TEMPLATE_TEST_CASE_SIG("N_GETTER_SETTER_NAME_TRAITS", "[N][GETTER_SETTER_NAME]", (typename Enc), rapidjson::UTF8<>, rapidjson::UTF16<>, rapidjson::UTF16LE<>, rapidjson::UTF16BE<>, rapidjson::UTF32<char32_t>, rapidjson::UTF32<unsigned>)
{
    SECTION("Can use as()", "[as]")
    {
        SECTION("to detect invalids")
        {
            REQUIRE_THROWS(as<n_getter_setter_name_trait_class, Enc>(STR_LITERAL(R"()")));
            REQUIRE_THROWS(as<n_getter_setter_name_trait_class, Enc>(STR_LITERAL(R"("unknown")")));
            REQUIRE_THROWS(as<n_getter_setter_name_trait_class, Enc>(
                STR_LITERAL(R"(
                {
                    "b": {
                            "battle-brother": "legion",
        ...
        {
            auto val = as<n_getter_setter_name_trait_class, Enc>(
                STR_LITERAL(R"(
                    {
                        "b": false,
                        "u32": 1234,
    ...
    SECTION("Can use to_json()", "[to_json]")
    {
        ...
        n_getter_setter_name_trait_class val;
        val.set_bool(false);
        val.set_uint32(1234);
        val.set_uint64(5678);
        val.set_string("Lupercal");
        ...
        auto json = to_json<n_getter_setter_name_trait_class, Enc>(val, doc.GetAllocator());
        REQUIRE_FALSE(json.IsNull());
        REQUIRE(json.IsObject());
    ...
    SECTION("Can use to_stream(std::ostream)", "[to_stream]")
    {
        ...
        to_stream<n_getter_setter_name_trait_class, Enc>(ss, val);
        auto value = ss.str();
...
TEMPLATE_TEST_CASE_SIG("TPL_ALL_GETTER_SETTER_NAME_TRAITS", "[TPL][ALL][GETTER_SETTER_NAME]", (typename Enc), rapidjson::UTF8<>, rapidjson::UTF16<>, rapidjson::UTF16LE<>, rapidjson::UTF16BE<>, rapidjson::UTF32<char32_t>, rapidjson::UTF32<unsigned>)
{
    using tpl_all_getter_setter_name_trait_class_isv = tpl_all_getter_setter_name_trait_class<int32_t, std::string, std::vector<float>>;

    SECTION("Can use as()", "[as]")
    {
        SECTION("to detect invalids")
        {
            REQUIRE_THROWS(as<tpl_all_getter_setter_name_trait_class_isv, Enc>(STR_LITERAL(R"()")));
            REQUIRE_THROWS(as<tpl_all_getter_setter_name_trait_class_isv, Enc>(STR_LITERAL(R"("unknown")")));
            REQUIRE_THROWS(as<tpl_all_getter_setter_name_trait_class_isv, Enc>(
                STR_LITERAL(R"(
                {
                    "t1": "",
                    "t2": "",
        ...
        auto val = as<tpl_all_getter_setter_name_trait_class_isv, Enc>(
            STR_LITERAL(R"(
                {
                    "t1": 162,
                    "t2": "Davin's moon",
    ...
    SECTION("Can use to_json()", "[to_json]")
    {
        ...
        tpl_all_getter_setter_name_trait_class_isv val;
        val.set_type1(162);
        val.set_type2("Davin's moon");
        val.set_type3({45.1f, 55.5f});

        auto json = to_json<tpl_all_getter_setter_name_trait_class_isv, Enc>(val, doc.GetAllocator());
        REQUIRE_FALSE(json.IsNull());
        REQUIRE(json.IsObject());
    ...
    SECTION("Can use to_stream(std::ostream)", "[to_stream]")
    {
        ...
        to_stream<tpl_all_getter_setter_name_trait_class_isv, Enc>(ss, val);
        auto value = ss.str();
        std::basic_string<typename Enc::Ch> output = STR_LITERAL(R"(
                {
                    "t1": 162,
...
TEMPLATE_TEST_CASE_SIG("TPL_N_GETTER_SETTER_NAME_TRAITS", "[TPL][N][GETTER_SETTER_NAME]", (typename Enc), rapidjson::UTF8<>, rapidjson::UTF16<>, rapidjson::UTF16LE<>, rapidjson::UTF16BE<>, rapidjson::UTF32<char32_t>, rapidjson::UTF32<unsigned>)
{
    using tpl_n_getter_setter_name_trait_class_isv = tpl_n_getter_setter_name_trait_class<int32_t, std::string, std::vector<float>>;

    SECTION("Can use as()", "[as]")
    {
        SECTION("to detect invalids")
        {
            REQUIRE_THROWS(as<tpl_n_getter_setter_name_trait_class_isv, Enc>(STR_LITERAL(R"()")));
            REQUIRE_THROWS(as<tpl_n_getter_setter_name_trait_class_isv, Enc>(STR_LITERAL(R"("unknown")")));
            REQUIRE_THROWS(as<tpl_n_getter_setter_name_trait_class_isv, Enc>(
                STR_LITERAL(R"(
                {
                    "t1": "",
                    "t2": "",
        ...
        SECTION("with all parameter")
        {
            auto val = as<tpl_n_getter_setter_name_trait_class_isv, Enc>(
                STR_LITERAL(R"(
                    {
                        "t1": 162,
                        "t2": "Davin's moon",
    ...
    SECTION("Can use to_json()", "[to_json]")
    {
        ...
        tpl_n_getter_setter_name_trait_class_isv val;
        val.set_type1(162);
        val.set_type2("Davin's moon");
        val.set_type3({45.1f, 55.5f});

        auto json = to_json<tpl_n_getter_setter_name_trait_class_isv, Enc>(val, doc.GetAllocator());
        REQUIRE_FALSE(json.IsNull());
        REQUIRE(json.IsObject());
    ...
    SECTION("Can use to_stream(std::ostream)", "[to_stream]")
    {
        ...
        to_stream<tpl_n_getter_setter_name_trait_class_isv, Enc>(ss, val);
        auto value = ss.str();
        std::basic_string<typename Enc::Ch> output = STR_LITERAL(R"(
                {
                    "t1": 162,
